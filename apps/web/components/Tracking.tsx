...
export function Tracking({ config, site, scope = 'site', page }: { config: Partial<TrackingConfig> | null | undefined; site?: TrackingConfig; scope?: 'site' | 'page'; page?: { id: string; title: string; type: string } }) {
  ...
  return (
    <>
      ...
      {load.openaiPixel ? <script id={`${prefix}oaiq`} dangerouslySetInnerHTML={{ __html: `(function(w,d,s,u){if(w.oaiq)return;var q=function(){q.q.push(arguments)};q.q=[];w.oaiq=q;var js=d.createElement(s);js.async=true;js.src=u;var f=d.getElementsByTagName(s)[0];f.parentNode.insertBefore(js,f)})(window,document,'script','https://bzrcdn.openai.com/sdk/oaiq.min.js');oaiq('init',{pixelId:'${clean(load.openaiPixel)}'});` }} /> : null}
