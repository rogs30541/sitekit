...
const PRESETS: Record<string, string> = {
  ...
  create_logistics_order: '{ "orderNo": "SK..." }',
  issue_invoice: '{ "orderNo": "SK..." }',
  invalidate_invoice: '{ "orderNo": "SK...", "reason": "退款" }',
  list_invoices: '{ "status": "issued" }',
  get_menu: '{ "location": "header" }',
  get_site: '{}',
  set_home_sections: '{ "sections": [ { "kind": "hero", "title": "歡迎", "subtitle": "一句話介紹", "ctaText": "看課程", "ctaHref": "/courses" }, { "kind": "courses", "title": "精選課程", "limit": 3 } ] }',
  set_menu: '{ "items": [ { "label": "首頁", "kind": "route", "href": "/" }, { "label": "關於", "kind": "page", "contentId": "<contentId>" } ] }',
  ...
  upsert_content: '{ "slug": "about", "type": "page", "title": "關於我們", "body": "<p>內文</p>" }',
  list_content: '{ "type": "page" }',
  get_content_draft: '{ "idOrSlug": "about" }',
  preview_content: '{ "idOrSlug": "about" }',
  publish_content: '{ "idOrSlug": "about", "confirm": true, "note": "改文案" }',
  list_revisions: '{ "idOrSlug": "about" }',
  restore_revision: '{ "idOrSlug": "about", "version": 1 }',
  import_page_design: '{ "slug": "landing", "title": "活動頁", "design": { "root": { "type": "root", "children": [ { "type": "section", "props": {}, "children": [ { "type": "heading", "props": { "level": 1, "text": "標題" } } ] } ] } } }',
  export_page_design: '{ "idOrSlug": "about" }',
