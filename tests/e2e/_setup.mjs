...
// 產圖模板（fixtures/image-templates.json 由本機主庫匯出；CI 全新 DB 沒有這 22 組）
import { existsSync, readFileSync } from 'node:fs';
const tpls = JSON.parse(readFileSync(new URL('./fixtures/image-templates.json', import.meta.url), 'utf8'));
let added = 0;
for (const t of tpls) {
