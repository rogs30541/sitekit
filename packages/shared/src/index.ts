...
export const OPS_ACTIONS = {
  ...
  set_tracking: { desc: '設定網站層級追蹤碼（套用到所有頁面；scroll{enabled,percents[],event} 頁面滑動深度事件；ga4、gtm、fbPixel、tiktok、lineTag、googleAdsId、googleAdsLabel、head、bodyTop、bodyBottom、events{pageView,viewContent,addToCart,initiateCheckout,purchase}）', mutating: true },
