...
/** 常用子頁（各套可覆寫） */
export const PAGES = {
  contact: (extra: Partial<SectionInput> = {}): TemplatePage => ({ slug: 'contact', title: '聯絡我們', sections: [{ kind: 'hero', variant: 'center', title: '聯絡我們', subtitle: '留下需求，我們會在一個工作天內回覆', compact: true, ...(extra.tone ? { tone: extra.tone } : {}) } as SectionInput, { kind: 'contact', variant: 'cards', showForm: false, items: [{ icon: 'mail', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }, { icon: 'chat', label: 'LINE', value: '@yourbrand', href: '' }], ...extra } as SectionInput] }),
  about: (): TemplatePage => ({ slug: 'about', title: '關於我們', sections: [{ kind: 'hero', variant: 'center', title: '關於我們', subtitle: '一句話說明我們是誰、為誰服務', compact: true }, { kind: 'split', title: '我們的故事', text: '在這裡寫下品牌的起點、理念與想帶來的改變。', bullets: ['理念一', '理念二', '理念三'], imageUrl: '' }, { kind: 'cta', variant: 'card', title: '想進一步了解？', buttonText: '聯絡我們', buttonHref: '/p/contact' }] }),
