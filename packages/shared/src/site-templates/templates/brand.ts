...
export const BRAND_TEMPLATES: SiteTemplate[] = [
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'columns', items: [{ icon: '✉️', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: '📷', label: 'Instagram', value: '@me', href: '' }] },
    ],
  ...
  },
  {
    ...
    home: [
      { kind: 'hero', variant: 'split', kicker: '你好', title: '我是你的名字', subtitle: '一句話說你做什麼、幫誰。', ctaText: '找我合作', ctaHref: '#contact', imageSide: 'left' },
      { kind: 'features', id: 'skills', variant: 'icons', title: '專長', columns: 3, items: [{ icon: '✍️', title: '專長一', text: '一句話' }, { icon: '🎤', title: '專長二', text: '一句話' }, { icon: '📊', title: '專長三', text: '一句話' }] },
      ...
      { kind: 'contact', id: 'contact', variant: 'cards', title: '聯絡我', items: [{ icon: '✉️', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: '💬', label: 'LINE', value: '@me', href: '' }] },
    ],
    pages: [aboutMe(), PAGES.contact()],
  },
  {
  ...
  },
  {
    ...
    home: [
      { kind: 'hero', variant: 'center', kicker: '每週更新', title: '你的頻道名', subtitle: '一句話。', ctaText: '訂閱', ctaHref: '#', cta2Text: '看最新', cta2Href: '#video', tone: 'dark' },
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'columns', items: [{ icon: '✉️', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: '📷', label: 'Instagram', value: '@me', href: '' }], tone: 'dark' },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'columns', title: '聯絡', items: [{ icon: '📍', label: '工作室', value: '地址', href: '' }, { icon: '📞', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', id: 'menu', variant: 'list', title: '菜單特色', items: [{ icon: '☕', title: '手沖', text: '一句話' }, { icon: '🥐', title: '烘焙', text: '一句話' }, { icon: '🍰', title: '甜點', text: '一句話' }] },
      { kind: 'gallery', id: 'gallery', variant: 'grid', title: '空間', columns: 3, items: [] },
      { kind: 'contact', id: 'map', variant: 'map', title: '交通與訂位', mapEmbedUrl: '', items: [{ icon: '📍', label: '地址', value: '地址', href: '' }, { icon: '🕒', label: '營業', value: '11:00–20:00', href: '' }, { icon: '📞', label: '訂位', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', id: 'features', variant: 'icons', columns: 3, items: [{ icon: '🎤', title: '亮點一', text: '一句話' }, { icon: '🤝', title: '亮點二', text: '一句話' }, { icon: '🎁', title: '亮點三', text: '一句話' }], tone: 'dark' },
