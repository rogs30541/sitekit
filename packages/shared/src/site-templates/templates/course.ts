...
export const COURSE_TEMPLATES: SiteTemplate[] = [
  {
    ...
    home: [
      ...
      { kind: 'categories', variant: 'icons', title: '課程分類', columns: 4, items: [{ icon: 'briefcase', title: '職場技能', href: '/courses' }, { icon: 'trending-up', title: '商業理財', href: '/courses' }, { icon: 'mic', title: '語言學習', href: '/courses' }, { icon: 'sprout', title: '自我成長', href: '/courses' }, { icon: 'palette', title: '興趣愛好', href: '/courses' }, { icon: 'laptop', title: '數位工具', href: '/courses' }, { icon: 'activity', title: '健康運動', href: '/courses' }, { icon: 'chef-hat', title: '生活料理', href: '/courses' }], tone: 'dark' },
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', variant: 'icons', title: '為什麼選我們', columns: 3, items: [{ icon: 'target', title: '實戰導向', text: '一句話' }, { icon: 'infinity', title: '無限期觀看', text: '一句話' }, { icon: 'chat', title: '講師答疑', text: '一句話' }] },
  ...
  },
  {
    ...
    home: [
      { kind: 'hero', variant: 'center', kicker: '已開課 · 可複製的系統', title: '一支手機，逆襲市場', subtitle: '全台唯一敢保證結果的課程。', ctaText: '立即報名', ctaHref: '/courses', highlights: [{ icon: 'film', title: '八大內容模組', text: '影片＋實作' }, { icon: 'chart-bar', title: '七套系統', text: '每步都有 SOP' }, { icon: 'smartphone', title: '萬用腳本', text: '照抄就能上手' }], tone: 'dark' },
      { kind: 'features', variant: 'grid', title: '你是不是也面臨這些困境？', columns: 4, items: [{ icon: 'frown', title: '痛點一', text: '一句話' }, { icon: 'frown', title: '痛點二', text: '一句話' }, { icon: 'frown', title: '痛點三', text: '一句話' }, { icon: 'meh', title: '痛點四', text: '一句話' }], tone: 'dark' },
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'cards', title: '聯絡我', items: [{ icon: 'mail', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: 'chat', label: 'LINE', value: '@me', href: '' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'categories', variant: 'tiles', title: '課程分類', columns: 4, items: [{ icon: 'music', title: '音樂', href: '/courses' }, { icon: 'palette', title: '美術', href: '/courses' }, { icon: 'activity', title: '舞蹈', href: '/courses' }, { icon: 'flask', title: '科學', href: '/courses' }] },
      ...
      { kind: 'contact', id: 'map', variant: 'map', title: '交通', mapEmbedUrl: '', items: [{ icon: 'map-pin', label: '教室', value: '地址', href: '' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
    pages: [aboutSchool, courseFaq, PAGES.contact()],
  },
  {
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', id: 'features', variant: 'icons', columns: 3, items: [{ icon: 'video', title: '影片', text: '一句話' }, { icon: 'file-text', title: '講義', text: '一句話' }, { icon: 'users', title: '社群', text: '一句話' }] },
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', variant: 'icons', columns: 4, items: [{ icon: 'layers', title: '特色一', text: '一句話' }, { icon: 'rainbow', title: '特色二', text: '一句話' }, { icon: 'shield', title: '特色三', text: '一句話' }, { icon: 'leaf', title: '特色四', text: '一句話' }] },
      ...
      { kind: 'contact', variant: 'map', title: '預約參觀', mapEmbedUrl: '', items: [{ icon: 'map-pin', label: '地址', value: '地址', href: '' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
    pages: [aboutSchool, courseFaq, PAGES.contact()],
  },
];
