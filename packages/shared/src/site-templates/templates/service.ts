...
export const SERVICE_TEMPLATES: SiteTemplate[] = [
  {
    ...
    home: [
      ...
      { kind: 'categories', variant: 'tiles', title: '服務領域', columns: 4, items: [{ icon: 'scale', title: '民事', href: '/p/services' }, { icon: 'building', title: '商事', href: '/p/services' }, { icon: 'users', title: '家事', href: '/p/services' }, { icon: 'shield', title: '刑事', href: '/p/services' }] },
      ...
      { kind: 'contact', variant: 'columns', title: '聯絡我們', items: [{ icon: 'map-pin', label: '事務所', value: '地址', href: '' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }, { icon: 'mail', label: 'Email', value: 'law@example.com', href: 'mailto:law@example.com' }] },
    ],
    pages: [svcPage([{ icon: 'scale', title: '民事', text: '一句話' }, { icon: 'building', title: '商事', text: '一句話' }, { icon: 'users', title: '家事', text: '一句話' }, { icon: 'shield', title: '刑事', text: '一句話' }]), svcAbout('關於事務所'), PAGES.contact()],
  },
  {
    ...
    home: [
      ...
      { kind: 'features', variant: 'grid', title: '服務', columns: 3, items: [{ icon: 'book', title: '記帳', text: '一句話' }, { icon: 'receipt', title: '報稅', text: '一句話' }, { icon: 'building', title: '公司登記', text: '一句話' }, { icon: 'trending-up', title: '財務規劃', text: '一句話' }, { icon: 'search', title: '簽證', text: '一句話' }, { icon: 'chat', title: '諮詢', text: '一句話' }] },
      ...
      { kind: 'contact', variant: 'cards', title: '聯絡', items: [{ icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }, { icon: 'mail', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', variant: 'icons', title: '服務項目', columns: 4, items: [{ icon: 'smile', title: '項目一', text: '一句話' }, { icon: 'heart-pulse', title: '項目二', text: '一句話' }, { icon: 'heart-pulse', title: '項目三', text: '一句話' }, { icon: 'sparkles', title: '項目四', text: '一句話' }] },
      ...
      { kind: 'contact', variant: 'map', title: '交通', mapEmbedUrl: '', items: [{ icon: 'map-pin', label: '地址', value: '地址', href: '' }, { icon: 'clock', label: '門診', value: '09:00–21:00', href: '' }, { icon: 'phone', label: '預約', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', id: 'contact', variant: 'cards', title: '你看完了。你的客戶也會。', items: [{ icon: 'chat', label: 'LINE', value: '@yourbrand', href: '' }, { icon: 'mail', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }], tone: 'dark' },
    ],
    pages: [{ slug: 'about', title: '關於我們', sections: [{ kind: 'hero', variant: 'center', title: '關於我們', subtitle: '一群熱愛短影音創作的行銷人', compact: true }, { kind: 'team', variant: 'founder', title: '創辦人', members: [{ name: '創辦人', role: '創辦人', bio: '三段以內。' }] }, { kind: 'features', variant: 'grid', title: '我們的使命', columns: 3, items: [{ icon: 'target', title: '使命一', text: '一句話' }, { icon: 'zap', title: '使命二', text: '一句話' }, { icon: 'users', title: '使命三', text: '一句話' }] }, { kind: 'team', variant: 'grid', title: '專業團隊', members: [{ name: '夥伴', role: '策略' }, { name: '夥伴', role: '製作' }, { name: '夥伴', role: '投放' }] }, { kind: 'cta', variant: 'band', title: '準備好一起創造成績了嗎？', buttonText: '免費諮詢', buttonHref: '/p/contact' }] }, svcPage([{ icon: 'film', title: '代營運', text: '一句話' }, { icon: 'award', title: '保證班', text: '一句話' }, { icon: 'building', title: '企業內訓', text: '一句話' }, { icon: 'rocket', title: '顧問陪跑', text: '一句話' }]), PAGES.contact({ tone: 'dark' })],
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'cards', title: '聯絡', items: [{ icon: 'phone', label: '電話', value: '0900-000-000', href: 'tel:+886900000000' }, { icon: 'chat', label: 'LINE', value: '@agent', href: '' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'columns', items: [{ icon: 'mail', label: 'Email', value: 'hello@example.com', href: 'mailto:hello@example.com' }, { icon: 'map-pin', label: '工作室', value: '地址', href: '' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'features', id: 'features', variant: 'grid', title: '功能特色', columns: 3, items: [{ icon: 'zap', title: '功能一', text: '一句話' }, { icon: 'link', title: '功能二', text: '一句話' }, { icon: 'chart-bar', title: '功能三', text: '一句話' }, { icon: 'shield', title: '功能四', text: '一句話' }, { icon: 'bot', title: '功能五', text: '一句話' }, { icon: 'globe', title: '功能六', text: '一句話' }] },
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'categories', id: 'services', variant: 'tiles', title: '服務項目', columns: 4, items: [{ icon: 'scissors', title: '剪髮', href: '#pricing' }, { icon: 'palette', title: '染髮', href: '#pricing' }, { icon: 'sparkles', title: '護髮', href: '#pricing' }, { icon: 'sparkles', title: '美甲', href: '#pricing' }] },
      ...
      { kind: 'contact', variant: 'map', title: '預約與交通', mapEmbedUrl: '', items: [{ icon: 'map-pin', label: '地址', value: '地址', href: '' }, { icon: 'phone', label: '預約', value: '02-0000-0000', href: 'tel:+886200000000' }] },
    ],
  ...
  },
  {
    ...
    home: [
      ...
      { kind: 'contact', variant: 'columns', title: '聯絡', items: [{ icon: 'map-pin', label: '台北', value: '地址', href: '' }, { icon: 'phone', label: '電話', value: '02-0000-0000', href: 'tel:+886200000000' }, { icon: 'mail', label: 'Email', value: 'info@example.com', href: 'mailto:info@example.com' }] },
    ],
